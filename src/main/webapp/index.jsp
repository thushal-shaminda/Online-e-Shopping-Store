						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Electronic</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Home & Garden</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Sporting Goods</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Work & Education</a></h4>
								</div>
							</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img height="300px" width="300px" object-fit="contain" src="data:image/gif;base64,${item.itemPhoto }" alt="" />
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>Rs. ${item.itemPrice }</h2>
												<p style="padding: 10px">${item.itemDesc }</p>
												<form id="form1" action="addtocart" method="post">
													<button type="submit" form="form1" class="btn btn-default add-to-cart" name="cartid" value="${item.itemNumber }"><i class="fa fa-shopping-cart"></i>Add to cart </button>													
												</form>
											</div>
										</div>
								</div>
